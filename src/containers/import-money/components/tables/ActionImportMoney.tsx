...
import UpdateImportMoneyModal from '../modals/UpdateImportMoney';

const ActionImportMoney = ({ row }: { row: IImportMoney }) => {
  ...
  const modalUpdateImportMoneyRef = useRef<FormDialogRef>(null);
  ...
  const openModalUpdateImportMoneyRef = () => {
    modalUpdateImportMoneyRef.current?.open();
  };

  const closeModalUpdateImportMoneyRef = () => {
    modalUpdateImportMoneyRef.current?.hide();
  };
  ...
  return (
    <>
      ...
      <UpdateImportMoneyModal
        modalUpdateImportMoneyRef={modalUpdateImportMoneyRef}
        closeModalUpdateImportMoneyRef={closeModalUpdateImportMoneyRef}
        row={row}
      />
    </>
  );
...
export default React.memo(ActionImportMoney, equals);
