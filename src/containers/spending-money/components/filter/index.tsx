...
import AddSpendingMoney from '../buttons/AddSpendingMoney';
...
const FilterSpendingMoney = ({
  setSpendingMoneyFilter,
}: {
  setSpendingMoneyFilter: (SpendingMoneyFilter: FilterForm) => void;
}) => {
  const { convertListYear } = useSpendingMoneyContext();
...
export default FilterSpendingMoney;
