...
import { ISpendingMoney, PriceTypeEnum } from '@/types';
import {
...
const UpdateSpendingMoneyModal = ({
  modalUpdateSpendingMoneyRef,
  closeModalUpdateSpendingMoneyRef,
  row,
}: {
  modalUpdateSpendingMoneyRef: RefObject<FormDialogRef>;
  closeModalUpdateSpendingMoneyRef: () => void;
  row: ISpendingMoney;
}) => {
  ...
  return (
    <>
      <FormDialog
        title={t('update_spending_money')}
        ref={modalUpdateSpendingMoneyRef}
...
export default UpdateSpendingMoneyModal;
