...
const AddSpendingMoneyModal = ({
  modalAddSpendingMoneyRef,
  closeModalAddSpendingMoneyRef,
}: {
  modalAddSpendingMoneyRef: RefObject<FormDialogRef>;
  closeModalAddSpendingMoneyRef: () => void;
}) => {
  ...
  return (
    <>
      <FormDialog
        title="Add Spending Money"
        ref={modalAddSpendingMoneyRef}
...
export default AddSpendingMoneyModal;
