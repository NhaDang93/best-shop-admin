...
import { IExchangeCash, PriceTypeEnum } from '@/types';
import {
...
const UpdateExchangeCashModal = ({
  modalUpdateExchangeCashRef,
  closeModalUpdateExchangeCashRef,
  row,
}: {
  modalUpdateExchangeCashRef: RefObject<FormDialogRef>;
  closeModalUpdateExchangeCashRef: () => void;
  row: IExchangeCash;
}) => {
  ...
  return (
    <>
      <FormDialog
        title={t('update_exchange_cash')}
        ref={modalUpdateExchangeCashRef}
...
export default UpdateExchangeCashModal;
