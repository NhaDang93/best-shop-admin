...
const AddExchangeCashModal = ({
  modalAddExchangeCashRef,
  closeModalAddExchangeCashRef,
}: {
  modalAddExchangeCashRef: RefObject<FormDialogRef>;
  closeModalAddExchangeCashRef: () => void;
}) => {
  ...
  return (
    <>
      <FormDialog
        title="Add Import Money"
        ref={modalAddExchangeCashRef}
...
export default AddExchangeCashModal;
