...
import AddExchangeCash from '../buttons/AddExchangeCash';
...
const FilterExchangeCash = ({
  setExchangeCashFilter,
}: {
  setExchangeCashFilter: (ExchangeCashFilter: FilterForm) => void;
}) => {
  const { t } = useTranslation();

  const { convertListYear } = useExchangeCashContext();
...
export default FilterExchangeCash;
