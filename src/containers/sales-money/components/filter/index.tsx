...
import AddSalesMoney from '../buttons/AddSalesMoney';
...
const FilterSalesMoney = ({
  setSalesMoneyFilter,
}: {
  setSalesMoneyFilter: (SalesMoneyFilter: FilterForm) => void;
}) => {
  const { t } = useTranslation();

  const { convertListYear, convertListMonth } = useSalesMoneyContext();
...
export default FilterSalesMoney;
