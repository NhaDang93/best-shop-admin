...
const AddHouseMoneyModal = ({
  modalAddHouseMoneyRef,
  closeModalAddHouseMoneyRef,
}: {
  modalAddHouseMoneyRef: RefObject<FormDialogRef>;
  closeModalAddHouseMoneyRef: () => void;
}) => {
  ...
  return (
    <>
      <FormDialog
        title="Add House Money"
        ref={modalAddHouseMoneyRef}
...
export default AddHouseMoneyModal;
