...
import AddHouseMoney from '../buttons/AddHouseMoney';
...
const FilterHouseMoney = ({
  setHouseMoneyFilter,
}: {
  setHouseMoneyFilter: (HouseMoneyFilter: FilterForm) => void;
}) => {
  const { t } = useTranslation();

  const { convertListYear } = useHouseMoneyContext();
...
export default FilterHouseMoney;
