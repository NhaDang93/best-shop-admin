...
import { IHouseFee, PriceTypeEnum } from '@/types';
import { backgroundStatusContract, responseParams } from '@/utils';
...
const UpdateHouseFeeModal = ({
  modalUpdateHouseFeeRef,
  closeModalUpdateHouseFeeRef,
  row,
}: {
  modalUpdateHouseFeeRef: RefObject<FormDialogRef>;
  closeModalUpdateHouseFeeRef: () => void;
  row: IHouseFee;
}) => {
  ...
  return (
    <>
      <FormDialog
        title={t('update_house_fee')}
        ref={modalUpdateHouseFeeRef}
...
export default UpdateHouseFeeModal;
