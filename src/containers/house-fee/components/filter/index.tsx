...
import AddHouseFee from '../buttons/AddHouseFee';
...
const FilterHouseFee = ({
  setHouseFeeFilter,
}: {
  setHouseFeeFilter: (houseFeeFilter: FilterForm) => void;
}) => {
  const { t } = useTranslation();

  const { convertListYear } = useHouseFeeContext();
